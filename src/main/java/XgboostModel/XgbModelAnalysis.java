...
/**
 * Created by qiguo on 18/1/19.
 */
public class XgbModelAnalysis {
    HashMap<String, String>mvItemsMp ;
    int[] featidx;
    Booster bst;

    public XgbModelAnalysis(String mvItemFeatsPath, String featsIdxPath, String ModelPath)
    ...
    public static void main(String[] args)throws IOException, XGBoostError{
        ...
        String testmv = args[3];
        //int topK = Integer.parseInt(args[3]);
        String outRes = args[4];
        BufferedWriter relatedRecbfw = new BufferedWriter(new FileWriter(outRes));

        XgbModelAnalysis XgbRelatedPred = new XgbModelAnalysis(movieFeatsPath, featuresIdxpath, modelPath);
        ...
        BufferedReader bfr = new BufferedReader(new FileReader(testmv));
        String line = "";
        while ((line = bfr.readLine()) != null){
            ...
            for(Map.Entry<String, String>entry : mvFeatMp.entrySet()){
                if(!entry.getKey().equals(mvid)){
                    ...
                    relatedRecbfw.write(mvid + "\t" + entry.getKey() + "\t" + res);
                    relatedRecbfw.flush();
