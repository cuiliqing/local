...
/**
 * Created by qiguo on 18/1/5.
 */
public class XgbRelatedRecPredPlusFeats {
    HashMap<String, String> mvItemsMp ;
    int[] featidx;
    Booster bst;

    public XgbRelatedRecPredPlusFeats(String mvItemFeatsPath, String featsIdxPath, String ModelPath)
    ...
    public static void main(String[] args)throws IOException, XGBoostError{
        ...
        XgbRelatedRecPredPlusFeats XgbRelatedPred = new XgbRelatedRecPredPlusFeats(movieFeatsPath, featuresIdxpath, modelPath);
