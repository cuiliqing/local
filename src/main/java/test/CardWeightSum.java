...
/**
 * Created by qiguo on 17/11/13.
 */
public class CardWeightSum {
    public static void main(String[] args)throws IOException{
        CardWeightSum cws = new CardWeightSum();
        HashMap<Integer, Double> modelMap = cws.getModelWeiMap("/Users/qiguo/Documents/fearureData/cardwei.txt");
        ...
        while((line = bfr2.readLine()) != null){
            HashMap<Integer, Double> likMap = cws.getLikes(line);
            HashMap<Integer,Double> resMap = cws.getResMap(mvMap,likMap);
            double res1 =0.0;
            //double res2 = 0.0;
            String str = "";
    ...
    HashMap<Integer, Double> getResMap(HashMap<Integer, Double> movmp1, HashMap<Integer, Double> likesmp2){
        ...
        int joinStartId = 3449;
        int joinEndId = 6896;
        int offset = joinEndId+1-joinStartId;
