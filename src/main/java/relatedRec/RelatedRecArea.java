 ...
 */
public class RelatedRecArea {
    HashMap<String, String> movItemSet;
    Model model;

    public RelatedRecArea(String movPth, String modelPth)throws IOException {
    ...
    public int[] getFeaturesIdx(String featIdxpth)throws IOException{
        ...
        String line = "";
        int cnt = 0;
        int[] feadIdx = new int[2];   //0: movieatagIdStart  1: jointagsIdStart
        while((line = bfr.readLine()) != null){
            if(cnt == 2){
                ...
                String[] ftId = line.split(":");
                feadIdx[1] = Integer.parseInt(ftId[1].trim());  // jointags join起始
            }
            else if(cnt > 3) break;
            cnt++;
        }
    ...
    public static void main(String[] args)throws IOException{
        ...
        RelatedRecArea rm = new RelatedRecArea(movSetPth, modelPth);
