...
/**
 * Created by qiguo on 17/11/23.
 * 电影的act，direct，area，tags 上映时间 全作为交叉特征
 */
public class RelatedRecFullJoin {
    HashMap<String, String> movItemSet;
    Model model;

    public RelatedRecFullJoin(String movPth, String modelPth)throws IOException {
    ...
    public static void main(String[] args)throws IOException{
        ...
        RelatedRecFullJoin rm = new RelatedRecFullJoin(movSetPth, modelPth);
