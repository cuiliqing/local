...
/**
 * Created by qiguo on 17/12/5.
 * 输入0: 模型文件model；1 特征id索引文件  2:用户偏好(格式： guid [id:val id:val])；3:电影item特征  4:topk；
 * 输出 5: 输出路径
 */
public class ModelPredSetJoinPsnLikes {
    Model model;
    HashMap<String, String> itemDict;
    public ModelPredSetJoinPsnLikes(String movieFeatsPath, String modelPath) throws IOException {
    ...
    public static void main(String[] args) throws IOException{
        ...
        ModelPredSetJoinPsnLikes modelPred = new ModelPredSetJoinPsnLikes(moviesPath, modelPath);  // 构造函数 两个文件路径
        ...
        while((line = bf.readLine()) != null){
            ...
            for(Map.Entry<String, String> entry : itemDict.entrySet()){
                ...
                double sc = predScore(feat, modelPred.model);
