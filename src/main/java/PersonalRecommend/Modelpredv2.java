 ...
 * 输出 5: 输出路径
 * (输出 6：中间结果数据输出路径 格式 guid movieId 0/1  id:val id:val ....)
 *
 */
public class Modelpredv2 {

    Model model;
    HashMap<String, String> itemDict;
    public Modelpredv2(String movieFeatsPath, String modelPath) throws IOException {
    ...
    public static void main(String[] args) throws IOException{
        ...
        Modelpredv2 modelPred = new Modelpredv2(moviesPath, modelPath);  // 构造函数 两个文件路径
